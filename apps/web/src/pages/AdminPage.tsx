          ...
          <div className="flex items-center gap-8 relative z-10">
             ...
             <div>
                ...
                <p className="text-rose-400/70 text-base font-medium max-w-lg leading-relaxed">
                   Automated threat detection and anomaly isolation is <span className="text-emerald-400 font-black">ACTIVE</span>. Root level override required.
                </p>
             </div>
          </div>
          <button className="btn-secondary bg-white text-background hover:bg-white/90 px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest relative z-10 active:scale-95">
